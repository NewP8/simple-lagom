...
//     FULL_HOSTNAME = "api-${DEPLOY_ENV}-${PROJECT_SHORTNAME}-${env.BUILD_NUMBER}-${SERVICE_VERSION}.${SUBDOMAIN_NAME}.${DOMAIN_NAME}"
...
//             sh 'kubectl apply --cluster gke_${GOOGLE_PROJECT_NAME}_${GOOGLE_ZONE_NAME}_${GOOGLE_TEST_CLUSTER_NAME} -f deploy/PlatformizationDeployment/kubernetes/resources/sdc-ingress/ -n ${APPS_NAMESPACE}'
//             // get ingress public ip
//             sh 'timeout 300 deploy/PlatformizationDeployment/kubernetes/scripts/kubectl-wait-for-ips'
